...
public class ColorDisplay extends JComponent {
    ...
    private int STRING_SIZE = 80; 	// Tillagd, fler än ett tecken, se setPages()
    ...
    // Tillgad för att sätta vidden på textarrayen.
    public void setPages(int STRING_SIZE) {
    ...
    public void setDisplay(int[][] colors, int verticalPage, int horizontalPage) {
        ...
        if(colors.length==PAGE_SIZE && colors[0].length== STRING_SIZE &&
